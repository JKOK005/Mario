		...
		const moveit_msgs::RobotState &start_robot_state,move_group_interface::MoveGroup::Plan &plan)
{
    ...
    ROS_INFO("robot_state: %f %f %f %f %f %f",start_robot_state.joint_state.position[0], start_robot_state.joint_state.position[1], start_robot_state.joint_state.position[2],start_robot_state.joint_state.position[3], start_robot_state.joint_state.position[4], start_robot_state.joint_state.position[5]);

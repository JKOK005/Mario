...
global_params 				= {
	"starting_position"	: [0.3131865660296839, 1.508597199116842, -2.4740939140319824, 2.142, 1.271, -pi/2],
	"ready_bin_A" 		: [-0.70, 1.2, -1.2536349296569824, 3.142, 2.3, -pi/2],
	"ready_bin_B"		: [0.00, pi/2, -pi/2, 3.142, pi/2, -pi/2],

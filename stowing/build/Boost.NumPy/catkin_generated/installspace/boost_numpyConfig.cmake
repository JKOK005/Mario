...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'boost_numpy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/apc16/apc_2016/mario_catkin_workspace/stowing/install/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()

...
if("TRUE" STREQUAL "TRUE")
  set(boost_numpy_SOURCE_PREFIX /home/apc16/apc_2016/mario_catkin_workspace/stowing/src/Boost.NumPy)
  set(boost_numpy_DEVEL_PREFIX /home/apc16/apc_2016/mario_catkin_workspace/stowing/devel)
  ...
  set(boost_numpy_INSTALL_PREFIX /home/apc16/apc_2016/mario_catkin_workspace/stowing/install)
...
if(NOT "/home/apc16/apc_2016/mario_catkin_workspace/stowing/src/Boost.NumPy " STREQUAL " ")
  set(boost_numpy_INCLUDE_DIRS "")
  set(_include_dirs "/home/apc16/apc_2016/mario_catkin_workspace/stowing/src/Boost.NumPy")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'boost_numpy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/apc16/apc_2016/mario_catkin_workspace/stowing/src/Boost.NumPy/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${boost_numpy_dep}_FOUND)
      find_package(${boost_numpy_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${boost_numpy_dep} REQUIRED ${depend_list})
  endif()
